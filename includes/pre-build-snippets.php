...
function run_filter()
{
    ...
    if (get_pbs_fields('tm_extraprooption_css_active') == 'yes') {
        add_action('wp_enqueue_scripts', 'pbs_enqueue_extraprocss');
    }
}
...
function pbs_enqueue_extraprocss()
{
    if (get_pbs_fields('tm_extraprooption_css_active') == 'yes') {
        wp_enqueue_style('pre-build-snippets-tm-extra', PRE_BUILD_SNIPPETS_URL . 'assets/css/tm-extra-product.css');
    }
}
